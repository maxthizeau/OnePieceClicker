...
import { getCaptainEffect, getMaximumHP, getMaximumXP, getThumbImageSrc, getUnitAttackPower } from "../../../lib/clickerFunctions"
      ...
      <TextWrapper>
        ...
        <InformationsStyled>
          <SpaceBetween>
            ...
            <span> ATK : {getUnitAttackPower(unit.unit, unit.level, unit.trainingCount)}</span>
          </SpaceBetween>
        </InformationsStyled>
